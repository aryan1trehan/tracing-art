...
function TimelineNode({
  ...
  return (
    ...
    >
      <p
        className="font-space-mono text-[#c9a84c] font-bold mb-12"
      ...
      <div style={{ height: 28 }} />
      <p
        className="font-cormorant italic text-[#8b7355] text-center mt-10 leading-tight"
...
export default function SceneTimeline({ scrollYProgress }: Props) {
  ...
  return (
    ...
    >
      ...
      >
        <motion.p
          className="font-space-mono text-[#c9a84c] text-xs tracking-widest uppercase mb-16 text-center"
        ...
        <div className="relative">
          ...
          >
            ...
            {/* Track */}
            <line x1="0" y1="60" x2="900" y2="60" stroke="#2a1f0e" strokeWidth="2" />
